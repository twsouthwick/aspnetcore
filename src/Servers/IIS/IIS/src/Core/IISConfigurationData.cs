...
internal struct IISConfigurationData : IISEnvironmentFeature
{
    ...
    Version IISEnvironmentFeature.IISVersion => version;

    string IISEnvironmentFeature.AppPoolId => pwzAppPoolId;

    string IISEnvironmentFeature.AppPoolConfig => pwzAppPoolConfig;

    string IISEnvironmentFeature.ApplicationId => pwzApplicationId;

    string IISEnvironmentFeature.SiteName => pwzSiteName;

    uint IISEnvironmentFeature.SiteId => siteId;

    string IISEnvironmentFeature.ApplicationPath => pwzFullApplicationPath;

    string IISEnvironmentFeature.ApplicationVirtualPath => pwzVirtualApplicationPath;
